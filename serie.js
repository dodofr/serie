      ...
      for (let i = 0; i < data.results.length; i++) {
        ...
        allBtn.addEventListener("click", (e) => {
          ...
          .then((data) => {
            ...
            enCour.innerHTML = "Date du dernier épisode : " + data.last_episode_to_air.air_date +" / "+ " Last saison : "
              + data.last_episode_to_air.season_number +" / " + " Last épisode : " + data.last_episode_to_air.episode_number
